...
function calculateCount(){
    ...
    total.innerText = document.querySelectorAll("#allCard .card").length
...
function updateDisplay(list){
    ...
    if(count === 0){
        allCardSection.style.display = 'none'
